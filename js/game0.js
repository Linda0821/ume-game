var apiCommon = "http://test.umeweb.com:8080/"; //"http://game.umeweb.cn/";//

var bannerURL = apiCommon + "cn_ume_api/game/api/top_games", //顶部banner API
    recommendURL = apiCommon + "cn_ume_api/game/api/1/games?offset=0", //热门推荐 API
    chessURL = apiCommon + "cn_ume_api/game/api/11/games?offset=0", //棋牌游戏 API
    allURL = apiCommon + "cn_ume_api/game/api/12/games?offset=0", // 捕鱼天地 API
    firstURL = "json/game.json", //首发游戏 API
    //firstURL = apiCommon + "cn_ume_api/js/json/game.json", //首发游戏 API
    singalURL = apiCommon + "cn_ume_api/game/api/13/games?offset=0", //单机游戏 API
    singleGameURL = apiCommon + "cn_ume_api/game/api/13/games?offset=",
    categoryURL = "json/category_n.json", //游戏分类 API
    //categoryURL = apiCommon + "cn_ume_api/js/json/category_n.json", //游戏分类 API
    offset = 0;
